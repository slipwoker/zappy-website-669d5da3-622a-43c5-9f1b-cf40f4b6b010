  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && !VALIDATORS.required(value)) {
        const label = contactForm.querySelector('label[for="' + (field.id || field.name) + '"]');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Game GG משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '669d5da3-622a-43c5-9f1b-cf40f4b6b010',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '669d5da3-622a-43c5-9f1b-cf40f4b6b010';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '669d5da3-622a-43c5-9f1b-cf40f4b6b010';
